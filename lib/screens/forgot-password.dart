...
import 'package:organyzebullet_app/widgets/background-image.dart';
...
class ForgotPassword extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      children: [
       BackgroundImage(image: 'assets/images/login.png'),
        Scaffold(
                ...
                child: Column(
                  children: [
                    ...
                    Container(
                      ...
                      child: Text(
                        'Enter email for instructions to reset your password',
                        style: kBodyText,
                      ),
                    ),
                    SizedBox(
