...
class updateEntry extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    _database.child(newPath).get().then((snapshot){
      final entryId = new Map<String,dynamic>.from(snapshot.value);
    });
    newnewPath = newPath+entryId;
      print(newnewPath);
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          print(newnewPath);
          r.createEntryWithPath(ID, newnewPath, title.text , type.text,  desc.text); },
        child: Icon(
          Icons.check,
        ),
      ),
